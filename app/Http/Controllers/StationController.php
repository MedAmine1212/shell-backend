...
class StationController extends Controller
{
    function findById($station_id) {
        $station = Station::where('id',$station_id)->with("stationAdmin.user")->with("employees.user")->with("workSchedule.workingDays")->with("stationServices.service")->with("stationProducts.product")->get()->first();
        if(!$station) {
